...
INSERT INTO skills_directory (name, address, date_of_birth, skills) VALUES
('John Doe', '23 King Street, Freetown', '1990-05-12', 'Web Development, React, Node.js'),
('Aisha Kamara', '45 Lumley Road, Freetown', '1987-09-25', 'Accounting, Financial Analysis, QuickBooks'),
('Mohamed Conteh', '12 Wilkinson Road, Freetown', '1995-11-03', 'Data Science, Machine Learning, Python'),
('Fatmata Sesay', '78 Aberdeen, Freetown', '1992-07-18', 'UI/UX Design, Figma, Adobe XD'),
('Samuel Koroma', '30 Regent Road, Freetown', '1998-02-10', 'Mobile App Development, React Native, Firebase');